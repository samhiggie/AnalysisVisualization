    ...
    for ievt, evt in enumerate(tree):
        ...
        for cat in allcats.keys():
            ...
            for process in processObj.cuts.keys():
                ...
                #print "process ",process,"  pro cuts ",procut

                #hWeights->GetSumOfWeights()
                ...
                if process not in ["data_obs","FF","FF_1","FF_2","FF_12"] and survive:
                    ...
                    for scalefactor in weightDict.keys():
                        ...
                        if scalefactor == "kfactor":
                            ...
                            weightfinal =  weightfinal * (returnValue(evt,weightDict[scalefactor]))
...
if __name__ == "__main__":
    ...
    from utils.Weights_2017 import CommonWeights
    ...
    parser.add_argument("-csv",  "--csvfile", default="MCsamples_2017_v6_yaml.csv",  help="categories yaml file")
    parser.add_argument("-i",  "--dir", default="/eos/user/s/shigginb/HAA_ntuples/June2020_2017/",  help="Input files")
    ...
    if not (args.datadrivenZH):
        for sample in sampleDict.keys():
            ...
            temppro.file=sample+"_2017.root"
    ...
    for objkey in HAA_processes.keys():
        if not objkey=="data":
            ...
            print HAA_processes[objkey].nickname+"_2017"
    ...
    if (args.datameasureZH):
        ...
        for proObj in HAA_processes.keys():
            if proObj!="data":  #isn't this right ... we want Prompt MC contribution 
                HAA_processes[proObj].cuts["prompt1"] = [["gen_match_4","!=",0]]
    ...
    DYJetsFile = ROOT.TFile.Open(dir+filelist["DYJetsToLL"],"read")
    ...
    for nickname in filelist.keys():
        ...
        calculateHistos(functs,tree,allcats[allcats.keys()[0]],allcats,HAA_processes,processObj,nickname,histodict,weightstring,weight,datadrivenPackage,args.verbose,args.test,weightHisto,jetWeightMultiplicity)
    ...
    for varcatPro in histodict.keys():
        ...
        #subtracting off fakes
        #if args.datadrivenZH:
        #    for histo in histodict.keys():
        #        if (varcatPro.split(":")[-1]==str("fake1_"+histo.split(":")[-1]) and varcatPro.split(":")[0]==histo.split(":")[0] and varcatPro.split(":")[1]==histo.split(":")[1]):
        #            histodict[varcatPro].Add(histodict[histo],-1)
        #            print varcatPro.split(":")[-1]," comp  ",str("fake1_"+histo.split(":")[-1])
        #        if (varcatPro.split(":")[-1]==str("fake2_"+histo.split(":")[-1]) and varcatPro.split(":")[0]==histo.split(":")[0] and varcatPro.split(":")[1]==histo.split(":")[1]):
        #            histodict[varcatPro].Add(histodict[histo],-1)
