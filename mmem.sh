...
output0=2016_${mainout}_dm_mmem
output1=2016_${mainout}_mmem
fo=2016_${mainout}_dm_mmem
cat=cat_mmem_2016.yaml


python MakeDistributions_v6.py -c $cat  -csv $csv  -i $input -p $process -dmZH -o $output0 -fo $fo -ch mmem
#python MakeDistributions_v6.py -c $cat  -csv $csv  -i $input -p $process -o $output0 -fo $fo -ch mmem
#python MakePlots_skimmed_sys.py -i skimmed_${output0}.root -o $output0 -c $cat --ch mmem -p $process
...
python MakeDistributions_v6.py -c $cat -csv $csv -i $input -p $process -o $output1 -ch mmem -s -ddZH -fi $fo -fo $output1 -ex

#echo "Making Plots ..."
#python MakePlots_skimmed.py -i skimmed_${output1}.root -o $output1 -c $cat --ch mmem -ddZH -p $process
#python MakePlots_skimmed.py -i skimmed_${output1}.root -o $output1 -c $cat --ch mmem -p $process
#
#python MakePlots_skimmed_sys.py -i skimmed_${output0}.root -o $output0 -c $cat --ch mmem -p $process -de
python MakePlots_skimmed_sys.py -i skimmed_${output1}.root -o $output1 -c $cat --ch mmem -p $process -de -ddZH
