...
#channel specific
output0=2016_example_dm_mmtt
output1=2016_example_mmtt
fo=2016_example_mmtt
...
echo "Making Plots ..."
python MakePlots_skimmed.py -i skimmed_${output1}_mmtt_inclusive.root -o $output1 -c $cat --ch mmtt -ddZH -p $process
